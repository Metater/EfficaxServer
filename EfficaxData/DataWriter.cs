...
namespace EfficaxData
{
    public class DataWriter
    {
        ...
        public void Put(float value)
        {
            ...
            Utils.FastBitConverter.GetBytes(_data, _position, value);
            _position += 4;
        }
        ...
        public void PutSBytesWithLength(sbyte[] data, int offset, int length)
        {
            ...
            Utils.FastBitConverter.GetBytes(_data, _position, length);
        ...
        public void PutSBytesWithLength(sbyte[] data)
        {
            ...
            Utils.FastBitConverter.GetBytes(_data, _position, data.Length);
